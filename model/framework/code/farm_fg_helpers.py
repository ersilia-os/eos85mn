# MIT License — FARM authors (see farm_molecular_representation LICENSE).
# Vendored from https://github.com/thaonguyen217/farm_molecular_representation
# src/helpers.py on the main branch.
